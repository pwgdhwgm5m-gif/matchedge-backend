...
async function persistFromMatch({league,season,fixtureId,kickoff,home,away,homeGoals,awayGoals,homeXg=null,awayXg=null}){
 try{
  ...
  const xgReady=Number.isFinite(Number(homeXg))&&Number.isFinite(Number(awayXg));
